...
The base and base plate should be printed in natural ASA (which can then be painted) at fastest speed, e.g. 0.2&nbsp;mm layer height, since there is no detail here to speak of, with 10% in-fill, supports everywhere, brim advisable

The steps and connector should be printed in the same way but in black ASA.
