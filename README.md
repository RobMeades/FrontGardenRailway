...
This, plus the two `.stl` exports at 30.48 scale, is a continuation of `viaduct_wall_*.stl` to be glued along the sides of the cureved concrete board that carries the track across the sump cap.  The walls should be printed in ASA, 10% in-fill, no supports required.